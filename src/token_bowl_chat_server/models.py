...
class User(BaseModel):
    ...
    created_by: Optional[str] = None  # Username of creator (only for bots)
...
class UserRegistration(BaseModel):
    ...
    webhook_url: Optional[HttpUrl] = None
    logo: Optional[str] = None
    role: Optional[Role] = None  # Explicit role assignment (optional)
...
class MessageResponse(BaseModel):
    ...
    id: str
    from_username: str
    from_user_logo: Optional[str] = None
    from_user_emoji: Optional[str] = None
    ...
    @classmethod
    def from_message(cls, message: Message, from_user: Optional[User] = None) -> "MessageResponse":
